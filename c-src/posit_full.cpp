...
extern "C" void p8e0_div(p8e0_t *res, p8e0_t *lhs, p8e0_t *rhs){
  ...
  p8e0_t pres = f_to_p8e0(fres);
  res->udata = sanitize_div8(lhs->udata, rhs->udata, fres, pres.udata);
...
extern "C" void p16e0_div(p16e0_t *res, p16e0_t *lhs, p16e0_t *rhs){
  ...
  p16e0_t pres = f_to_p16e0(fres);
  res->udata = sanitize_div16(lhs->udata, rhs->udata, fres, pres.udata);
...
extern "C" void p32e0_div(p32e0_t *res, p32e0_t *lhs, p32e0_t *rhs){
  ...
  p32e0_t pres = f_to_p32e0(fres);
  res->udata = sanitize_div32(lhs->udata, rhs->udata, fres, pres.udata);
...
extern "C" p8e0_t p8e0_exp2(p8e0_t x){
  ...
  if (isinf(fres)){res.udata = P8MAXREAL; return res;}
  if (fres == 0)  {res.udata = P8POSSMALL; return res;}

  return f_to_p8e0(fres);
}
...
extern "C" p16e0_t p16e0_exp2(p16e0_t x){
  ...
  if (isinf(fres)){res.udata = P16MAXREAL; return res;}
  if (fres == 0)  {res.udata = P16POSSMALL; return res;}

  return f_to_p16e0(fres);
}
...
extern "C" p32e0_t p32e0_exp2(p32e0_t x){
  ...
  if (isinf(fres)){res.udata = P32MAXREAL; return res;}
  if (fres == 0)  {res.udata = P32POSSMALL; return res;}

  return f_to_p32e0(fres);
}
...
extern "C" void p8e0_fma(p8e0_t *res, p8e0_t *a,   p8e0_t *b,   p8e0_t *c){
  ...
  res->udata = sanitize_fma8(a->udata, b->udata, c->udata, fres, pres.udata, z_count_valid);
}
...
extern "C" void p16e0_fma(p16e0_t *res, p16e0_t *a,   p16e0_t *b,   p16e0_t *c){
  ...
  res->udata = sanitize_fma16(a->udata, b->udata, c->udata, fres, pres.udata, z_count_valid);
}
...
extern "C" void p32e0_fma(p32e0_t *res, p32e0_t *a,   p32e0_t *b,   p32e0_t *c){
  ...
  res->udata = sanitize_fma32(a->udata, b->udata, c->udata, fres, pres.udata, z_count_valid);
}

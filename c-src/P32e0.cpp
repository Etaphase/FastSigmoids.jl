...
P32e0 &P32e0::operator *=(const P32e0 rhs){
  ...
  if (set_nan_jmp()) {
    p32e0_mul_j((p32e0_t *) this, lhs, (p32e0_t) rhs);
  } else {
...
P32e0 P32e0::operator *(const P32e0 rhs){
  ...
  if (set_nan_jmp()){
    p32e0_mul(&res, (p32e0_t) (*this), (p32e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator *");
  }
  return res;
...
P32e0 &P32e0::operator -=(const P32e0 rhs){
  ...
  if (set_nan_jmp()) {
    p32e0_sub_j((p32e0_t *) this, lhs, (p32e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator -=");
  }
  return (*this);
...
P32e0 P32e0::operator -(const P32e0 rhs){
  p32e0_t res;          //create a return value on the stack.
  if (set_nan_jmp()){
    p32e0_sub(&res, (p32e0_t) (*this), (p32e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator -");
  }
  return res;
...
P32e0 &P32e0::operator +=(const P32e0 rhs){
  ...
  if (set_nan_jmp()) {
    p32e0_add_j((p32e0_t *) this, lhs, (p32e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator +=");
  }
  return (*this);
...
P32e0 P32e0::operator +(const P32e0 rhs){
  p32e0_t res;          //create a return value on the stack.
  if (set_nan_jmp()){
    p32e0_add(&res, (p32e0_t) (*this), (p32e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator +");
  }
  return res;
...
P32e0 &P32e0::operator /=(const P32e0 rhs){
  ...
  if (set_nan_jmp()) {
    p32e0_div_j((p32e0_t *) this, lhs, (p32e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator /=");
  }
  return (*this);
...
P32e0 P32e0::operator /(const P32e0 rhs){
  p32e0_t res;          //create a return value on the stack.
  if (set_nan_jmp()){
    p32e0_div(&res, (p32e0_t) (*this), (p32e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator /");
  }
  return res;

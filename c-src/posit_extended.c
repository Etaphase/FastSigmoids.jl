...
extern "C" p8e0_t p8e0_atan2(p8e0_t a, p8e0_t b){
  return f_to_p8e0(atan2(p8e0_to_f(x),p8e0_to_f(y)));
}
extern "C" p8e1_t p8e1_atan2(p8e1_t a, p8e1_t b){
  return f_to_p8e1(atan2(p8e1_to_f(x),p8e1_to_f(y)));
}
extern "C" p8e2_t p8e2_atan2(p8e2_t a, p8e2_t b){
  return f_to_p8e2(atan2(p8e2_to_f(x),p8e2_to_f(y)));
}
extern "C" p16e0_t p16e0_atan2(p16e0_t a, p16e0_t b){
  return f_to_p16e0(atan2(p16e0_to_f(x),p16e0_to_f(y)));
}
extern "C" p16e1_t p16e1_atan2(p16e1_t a, p16e1_t b){
  return f_to_p16e1(atan2(p16e1_to_f(x),p16e1_to_f(y)));
}
extern "C" p16e2_t p16e2_atan2(p16e2_t a, p16e2_t b){
  return f_to_p16e2(atan2(p16e2_to_f(x),p16e2_to_f(y)));
}
extern "C" p32e0_t p32e0_atan2(p32e0_t a, p32e0_t b){
  return f_to_p32e0(atan2(p32e0_to_f(x),p32e0_to_f(y)));
}
extern "C" p32e1_t p32e1_atan2(p32e1_t a, p32e1_t b){
  return f_to_p32e1(atan2(p32e1_to_f(x),p32e1_to_f(y)));
}
extern "C" p32e2_t p32e2_atan2(p32e2_t a, p32e2_t b){
  return f_to_p32e2(atan2(p32e2_to_f(x),p32e2_to_f(y)));
}
extern "C" p32e3_t p32e3_atan2(p32e3_t a, p32e3_t b){
  return f_to_p32e3(atan2(p32e3_to_f(x),p32e3_to_f(y)));
}

...
P32e2 &P32e2::operator *=(const P32e2 rhs){
  ...
  if (set_nan_jmp()) {
    p32e2_mul_j((p32e2_t *) this, &lhs, &rhs);
  } else {
...
P32e2 P32e2::operator *(const P32e2 rhs){
  ...
  if (set_nan_jmp()){
    p32e2_mul(&res, (p32e2_t *) this, &rhs);
  } else {
    throw domain_error("NaN value obtained in operator *");
  }
  return res;
...
P32e2 &P32e2::operator -=(const P32e2 rhs){
  ...
  if (set_nan_jmp()) {
    p32e2_sub_j((p32e2_t *) this, &lhs, &rhs);
  } else {
    throw domain_error("NaN value obtained in operator -=");
  }
  return (*this);
...
P32e2 P32e2::operator -(const P32e2 rhs){
  p32e2_t res;          //create a return value on the stack.
  if (set_nan_jmp()){
    p32e2_sub(&res, (p32e2_t *) this, &rhs);
  } else {
    throw domain_error("NaN value obtained in operator -");
  }
  return res;
...
P32e2 &P32e2::operator +=(const P32e2 rhs){
  ...
  if (set_nan_jmp()) {
    p32e2_add_j((p32e2_t *) this, &lhs, &rhs);
  } else {
    throw domain_error("NaN value obtained in operator +=");
  }
  return (*this);
...
P32e2 P32e2::operator +(const P32e2 rhs){
  p32e2_t res;          //create a return value on the stack.
  if (set_nan_jmp()){
    p32e2_add(&res, (p32e2_t *) this, &rhs);
  } else {
    throw domain_error("NaN value obtained in operator +");
  }
  return res;
...
P32e2 &P32e2::operator /=(const P32e2 rhs){
  ...
  if (set_nan_jmp()) {
    p32e2_div_j((p32e2_t *) this, &lhs, &rhs);
  } else {
    throw domain_error("NaN value obtained in operator /=");
  }
  return (*this);
...
P32e2 P32e2::operator /(const P32e2 rhs){
  p32e2_t res;          //create a return value on the stack.
  if (set_nan_jmp()){
    p32e2_div(&res, (p32e2_t *) this, &rhs);
  } else {
    throw domain_error("NaN value obtained in operator /");
  }
  return res;

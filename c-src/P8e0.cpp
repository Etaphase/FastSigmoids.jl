...
P8e0 &P8e0::operator *=(const P8e0 rhs){
  ...
  int status = p8e0_mul((p8e0_t *) this, lhs, (p8e0_t) rhs);
  if (status != 0){ throw domain_error("NaN value obtained in operator *="); }
...
P8e0 P8e0::operator *(const P8e0 rhs){
  ...
  if (set_nan_jmp()){
    p8e0_mul(&res, (p8e0_t) (*this), (p8e0_t) rhs);
  } else {
...
P8e0 &P8e0::operator -=(const P8e0 rhs){
  ...
  int status = p8e0_sub((p8e0_t *) this, lhs, (p8e0_t) rhs);
  if (status != 0){ throw domain_error("NaN value obtained in operator -="); }
...
P8e0 P8e0::operator -(const P8e0 rhs){
  ...
  if (set_nan_jmp()){
    p8e0_sub(&res, (p8e0_t) (*this), (p8e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator -");
  }
...
P8e0 &P8e0::operator +=(const P8e0 rhs){
  ...
  int status = p8e0_add((p8e0_t *) this, lhs, (p8e0_t) rhs);
  if (status != 0){ throw domain_error("NaN value obtained in operator +="); }
...
P8e0 P8e0::operator +(const P8e0 rhs){
  ...
  if (set_nan_jmp()){
    p8e0_add(&res, (p8e0_t) (*this), (p8e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator +");
  }
...
P8e0 &P8e0::operator /=(const P8e0 rhs){
  ...
  int status = p8e0_div((p8e0_t *) this, lhs, (p8e0_t) rhs);
  if (status != 0){ throw domain_error("NaN value obtained in operator /="); }
...
P8e0 P8e0::operator /(const P8e0 rhs){
  ...
  if (set_nan_jmp()){
    p8e0_div(&res, (p8e0_t) (*this), (p8e0_t) rhs);
  } else {
    throw domain_error("NaN value obtained in operator /");
  }
